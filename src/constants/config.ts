...
if (!fs.existsSync(path.resolve(envFilename))) {
  ...
  console.log(`Lưu ý: App không dùng file .env, ví dụ môi trường là development thì app sẽ dùng .env.development`)
...
export const envConfig = {
  ...
  dbMessageConversationCollection: process.env.DB_MESSAGE_CONVERSATION as string,
