...
const uri = `mongodb+srv://${envConfig.dbUsername}:${envConfig.dbPassword}@twitter.nu4wffb.mongodb.net/?retryWrites=true&w=majority`
...
class DatabaseService {
  ...
  get conversations(): Collection<Conversation> {
    return this.db.collection(envConfig.dbMessageConversationCollection)
  }
}
